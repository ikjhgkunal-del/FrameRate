...
const SECTIONS = [
  { key: "popular", title: "Popular Movies", url: `${BASE}/movie/popular?api_key=${API_KEY}` },
  { key: "top_rated", title: "Top Rated", url: `${BASE}/movie/top_rated?api_key=${API_KEY}` },
  { key: "now_playing", title: "Now Playing", url: `${BASE}/movie/now_playing?api_key=${API_KEY}` },
  { key: "upcoming", title: "Upcoming", url: `${BASE}/movie/upcoming?api_key=${API_KEY}` },
  { key: "hindi", title: "Hindi Movies", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_original_language=hi&sort_by=popularity.desc` },
  { key: "korean", title: "Korean Movies", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_original_language=ko&sort_by=popularity.desc` },
  { key: "anime", title: "Anime Movies", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_genres=16&with_original_language=ja&sort_by=popularity.desc` },
  { key: "action", title: "Action & Adventure", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_genres=28&sort_by=popularity.desc` },
  { key: "comedy", title: "Comedy", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_genres=35&sort_by=popularity.desc` },
  { key: "thriller", title: "Thriller", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_genres=53&sort_by=popularity.desc` },
  { key: "horror", title: "Horror", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_genres=27&sort_by=popularity.desc` },
  { key: "romance", title: "Romance", url: `${BASE}/discover/movie?api_key=${API_KEY}&with_genres=10749&sort_by=popularity.desc` },
];
